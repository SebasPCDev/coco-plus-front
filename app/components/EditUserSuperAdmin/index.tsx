            ...
            <div className="mt-10 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-4">
              ...
              <div className="sm:col-span-2 sm:col-start-1">
                ...
                <div className="mt-2">
                  ...
                  >
                    <option value="adminCompany">
                      Aministrador de compañia
                    </option>
                    <option value="adminCoworking">
                      Aministrador de coworking
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative flex items-center justify-center gap-2 rounded-lg border-2 bg-custom-white">
                  ...
                  <button
                    ...
                    className="absolute right-3 rounded px-2 py-1 text-gray-700"
                  >
