...
export default function SideNav() {
  ...
  return (
    <div className="">
      ...
      <div
        className={`${styles.linksContainerResponsive} ${activeNav} flex flex-col items-center justify-center px-3 py-4 md:fixed md:h-full md:w-56 md:px-2`}
      >
        <Link
        ...
        <div
          ...
          className={`${styles.linksResponsiveContainer} flex w-2/3 flex-col space-x-1  md:w-full md:grow md:flex-col md:space-x-0 md:space-y-2`}
        >
          <NavLinks />
