...
export const Footer = () => {
  return (
    <footer className="   gradient-footer             text-center text-white/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div
          ...
          className="grid-1 mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-4"
        >
          <div className="">
            <Image
            ...
            />
            <p>
              Conectamos empresas con espacios de coworking, impulsando un
              modelo laboral híbrido y mejorando el bienestar de tus
              colaboradores.
            </p>
          </div>
